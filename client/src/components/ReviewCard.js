  ...
  return (
    <div className='flex flex-col w-full justify-evenly bg-white mb-3 rounded-lg p-3 sm:px-9'>
        <div className='flex flex-row flex-wrap w-full justify-between'>
            <h3 className='font-bold text-2xl mr-4'>{reviewData.author.username}</h3>
            <div>
                <StarRate rating={reviewData.rating} />
            </div>
        </div>
        <div className='w-full my-4 text-base text-justify sm:text-xl'>{reviewData.comment}</div>
        <div className='flex flex-row w-full my-3'>
            <div className='flex flex-row items-center mr-3'>
                ...
                <div className='text-lg'>{reviewData.likes.length}</div>
            </div>
            <div className='flex flex-row items-center'>
                ...
                <div className='text-lg'>{reviewData.dislikes.length}</div>
            </div>
        </div>
        <div className='w-full text-end text-xl font-bold'>{reviewData.date}</div>
    </div>
  )
}
