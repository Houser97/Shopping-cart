  ...
  return (
    <div className='flex flex-col w-full justify-evenly bg-white mb-3 rounded-lg p-3 sm:px-9'>
        ...
        <div className='flex flex-row w-full my-3 mb-5 relative'>
            ...
            <Link className={`rounded-lg font-bold text-lg bg-blue-600 text-white px-5 
            py-1 absolute right-0 top-0 tracking-wider cursor-pointer ${user ? author._id === user.id ? 'flex':'hidden':'hidden'}`
