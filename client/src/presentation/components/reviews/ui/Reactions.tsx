...
import { ReactionsEnum } from "../../../../domain/entities/reaction"
import { useTypedSelector } from "../../../store/config/typed-selector";
import { useReaction } from "../../../hooks/useReaction";


export const Reactions = ({ totalReactions, userReaction, productId, reviewId }) => {

    const { reaction: reactionEntity, createReaction, updateReaction } = useReaction(userReaction);
    ...
    const { status, user } = useTypedSelector(state => state.auth);

    const updateLocalReactionsCount = (reaction: string) => {
    ...
    const create = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        updateLocalReactionsCount(reaction);
    }
    ...
    const update = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        updateLocalReactionsCount(newReaction);
    }
