    ...
    return(
        <div className="card">
            ...
            <div className="card-decrase-increase">
                <button className='decrease-button button-IncDec' onClick={decrementProduct}>
                ...
                <button data-testid="0" className='increase-button button-IncDec' onClick={incrementProduct}>
            ...
            <div className='add-product'>
                <button className='add-to-cart' onClick={() => addProduct(numberOfProducts, id)}>Add to cart</button>
            </div>
        </div>
    )
}
