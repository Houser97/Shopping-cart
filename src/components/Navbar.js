...
const Navbar = ({toggle}) => {
    ...
    return(
        <nav className={`flex flex-col justify-center absolute left-0 top-full bg-header 
        ...
        ${toggle ? 'translate-x-0':'-translate-x-full'} `}>
                ...
                items-start text-white h-full font-bold text-2xl' to = "/shop">
                    <div data-testid="test-shop-link" className='flex flex-row justify-center items-center gap-1 cursor-pointer'>
