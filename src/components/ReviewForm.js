...
const ReviewForm = () => {
  ...
  return (
    <div className='flex justify-center items-center w-full min-h-screen px-3 py-20 bg-[#091F44] mt-10 xs:px-10'>
        <div className='grid grid-rows-[min-content,minmax(0,1fr)] grid-cols-1 justify-center items-center gap-5 p-5 w-full bg-white rounded-2xl md:grid-cols-[minmax(0,350px),minmax(300px,1fr)]'>
            ...
            <form className='flex flex-col w-full h-full text-3xl justify-around'>
                ...
                <textarea className='max-h-60 h-60 text-xl p-2 border-solid border-gray-400 border-2 outline-none rounded-md'></textarea>
